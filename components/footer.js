...
export const Footer = () => (
  <Container as="footer" role="contentinfo" paddingTop={90} paddingBottom={1}>
    <Center spacing={{ base: '4', md: '5' }}>
      <Stack justify="space-between" direction="row" align="center">
        <ButtonGroup variant="tertiary">
          ...
          <IconButton as="a" target="_blank" href="https://instagram.com/roozbeh.05" aria-label="Instagram" icon={<FaInstagram />} variant='ghost'/>
        </ButtonGroup>
      </Stack>
    </Center>
  </Container>
